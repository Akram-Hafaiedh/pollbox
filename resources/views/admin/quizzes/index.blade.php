        ...
        <tbody class="text-sm">
            ...
            <tr class="hover:bg-indigo-100 odd:bg-gray-100 even:bg-white">
                ...
                <td class="flex justify-center space-x-1">
                    ...
                    <form @submit.prevent="isOpenDeleteSingle = true"
                        action="{{ route('admin.quizzes.destroy', $quiz) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
                        <button @click.prevent="isOpenDeleteSingle = true; quizIdToDelete = {{ $quiz->id }}"
                            type="submit"
